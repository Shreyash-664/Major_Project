          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addProduct" value="Add Product" class="btn bn-success" value="">
                  </div>
                </div>
              </form>
            </div>
...
.bn-success:not(:disabled):not(.disabled):active,
.bn-success:not(:disabled):not(.disabled).active,
.show > .bn-success.dropdown-toggle
{
    color: #fff;
    border-color: #2dce89; 
    background-color: #24a46d;
}
.bn-success:not(:disabled):not(.disabled):active:focus,
.bn-success:not(:disabled):not(.disabled).active:focus,
.show > .bn-success.dropdown-toggle:focus
{
